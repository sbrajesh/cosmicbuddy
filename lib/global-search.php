...
function bpmag_show_member_search(){
   ...
   <div class="widgettitle pagetitle"><?php _e("Members Results","bpmag");?></div>
...
<div class="widgettitle pagetitle"><?php _e("Group Search","bpmag");?></div>
	<div class="widget-content">
...
function bpmag_show_site_blog_search(){
 ...
 <div class="widgettitle pagetitle"><?php _e("Blog Search","bpmag");?></div>
	<div class="widget-content">
...
function bpmag_show_forums_search(){
 ...
 <div class="widgettitle pagetitle"><?php _e("Forums Search","bpmag");?></div>
	<div class="widget-content">
...
function bpmag_show_blogs_search(){
  ...
  <div class="widgettitle pagetitle"><?php _e("Blogs Search","bpmag");?></div>
	<div class="widget-content">
