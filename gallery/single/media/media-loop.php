		...
		<?php while(bp_gallery_medias()):bp_gallery_the_media() ;?>
			...
			<div <?php bp_media_css();?> id="gallery_media_<?php bp_media_id();?>">
				<div class="media-content">
					...
					<div class='edit-delete'><a href="<?php bp_media_permalink();?>" class='mcomments'><?php _e("comments","bp-gallery");?>(<?php global $medias_template; echo get_activity_comment_count($medias_template->media->id);?>)</a>
