 ...
 * 
 * File generated: Sat May 08 19:07:12 GMT 2010
 */
...
/*** Login box********/
var j=jQuery;
j("#wp-admin-bar .bp-login a,#search-user-bar a#login-link").attr("rel","#login_box");
j("#wp-admin-bar .bp-login a[rel],#search-user-bar a#login-link[rel]").overlay({
			...
			closeOnEsc:true,
                        onLoad:function (){
                            j("#login_box #sidebar-user-login").focus();
                        }
