<?php if ( bp_has_forum_topics( bp_ajax_querystring( 'forums' ) ) ) : ?>
	...
	<div class="pagination">
		...
		<div id="post-count" class="pag-count">
			<?php if ( bp_is_group_forum() && is_user_logged_in() ) : ?>
				<a href="#post-new" class="button"><?php _e( 'New Topic', 'bpmag' ) ?></a> &nbsp;
			<?php endif; ?>
	...
	<table class="forum">
		...
		<tr>
			<th id="th-title"><?php _e( 'Topic Title', 'bpmag' ) ?></th>
			<th id="th-poster"><?php _e( 'Latest Poster', 'bpmag' ) ?></th>

			<?php if ( !bp_is_group_forum() ) : ?>
				<th id="th-group"><?php _e( 'Posted In Group', 'bpmag' ) ?></th>
			<?php endif; ?>

			<th id="th-postcount"><?php _e( 'Posts', 'bpmag' ) ?></th>
			<th id="th-freshness"><?php _e( 'Freshness', 'bpmag' ) ?></th>
		</tr>
		...
		<tr class="<?php bp_the_topic_css_class() ?>">
			<td class="td-title">
				<a class="topic-title" href="<?php bp_the_topic_permalink() ?>" title="<?php bp_the_topic_title() ?> - <?php _e( 'Permalink', 'bpmag' ) ?>">
