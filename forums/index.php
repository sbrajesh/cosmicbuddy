...
<div id="contents">
	...
	<div id="content">
		...
		<form action="" method="post" id="forums-directory-form" class="dir-form">
			...
			<h2 class="widgettitle"><?php _e( 'Group Forums Directory', 'buddypress' ); ?><?php if ( is_user_logged_in() ) : ?> &nbsp;<a class="button show-hide-new" href="#new-topic" id="new-topic-button"><?php _e( 'New Topic', 'buddypress' ); ?></a><?php endif; ?></h2>
