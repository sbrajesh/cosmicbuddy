						...
						<div id="global-forum-topic-filters">
							<ul>
								...
								<?php if ( isset( $_GET['fs'] ) ) : ?>
									<li class="selected" id="forums-search"><a href="<?php bp_newest_forum_topics_link() ?>" title="<?php _e( 'Search', 'buddypress' ) ?>"><?php printf( __( 'Matching: %s', 'buddypress' ), esc_attr( $_GET['fs'] ) ) ?></a></li>
								<?php endif; ?>
